    ...
    <div class="flex justify-between items-center h-16">
      ...
      <div class="flex items-center gap-8">
        <a href="/" class="flex items-center gap-2">
          ...
          <span class="font-bold text-xl tracking-tight">QR Anbessa</span>
        </a>
        ...
        <nav class="hidden md:flex items-center gap-6">
          ...
          <a href="#customers" class="text-sm font-medium text-gray-600 hover:text-gray-900">Customers</a>
          <a href="#support" class="text-sm font-medium text-gray-600 hover:text-gray-900">Support</a>
        </nav>
      </div>
